...
CI1.2    PG1.2.1  PG1.2.2  CD
SE2      CI2.1    PG2.1.1  -
```

### 5x3構成（15ペイン）
```
SE1      CI1.1    PG1.1.1  PG1.1.2  PG1.1.3
CI1.2    PG1.2.1  PG1.2.2  PG1.2.3  CD
SE2      CI2.1    PG2.1.1  PG2.1.2  -
```
...
# グリッド表示（3x3の例）
printf "\033[36m%-8s\033[0m \033[32m%-8s\033[0m \033[32m%-8s\033[0m\n" "SE1" "CI1.1" "PG1.1.1"
printf "\033[32m%-8s\033[0m \033[33m%-8s\033[0m \033[33m%-8s\033[0m\n" "PG1.1.2" "CI1.2" "PG1.2.1"
printf "\033[31m%-8s\033[0m %-8s %-8s\n" "CD" "-" "-"
```
